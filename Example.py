...
filepath = r"C:\Users\sharm\Desktop\Btech project MP22CST04\Source code\Prototype\TomatoDisease\Plant-Leaf-Disease-Prediction\model.h5"
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread(r"C:\Users\sharm\Desktop\Btech project MP22CST04\Source code\Prototype\TomatoDisease\Plant-Leaf-Disease-Prediction\Dataset\test\Tomato___Bacterial_spot (1).JPG")
